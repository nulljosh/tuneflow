...
name.split('').forEach((letter, i) => {
    ...
    ctx.fillText(letter, xPos + 6, yPos + 6);
...
fs.writeFileSync('/Users/joshua/.openclaw/workspace/80s-sylvia.png', buffer);
console.log('Image saved to: /Users/joshua/.openclaw/workspace/80s-sylvia.png');
